...
Este é meu portfólio pessoal, desenvolvido do zero para apresentar minhas habilidades, projetos e experiência como desenvolvedor júnior. O site foi criado com foco em **design moderno**, **responsividade** e **performance**.
